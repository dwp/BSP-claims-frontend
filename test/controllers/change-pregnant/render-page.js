...
const {renderPage} = require('../../../src/pages/change-pregnant/functions');
const template = require('../../../src/pages/change-pregnant/template.marko');
...
test('should render correct template when session is empty', async t => {
  const {req, res} = t.context.setup();
