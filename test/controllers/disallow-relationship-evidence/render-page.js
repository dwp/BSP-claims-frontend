...
const {renderPage} = require('../../../src/pages/disallow-relationship-evidence/functions');
const template = require('../../../src/pages/disallow-relationship-evidence/template.marko');
